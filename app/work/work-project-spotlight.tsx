...
export function WorkProjectSpotlight({
  ...
  const hasProjectSelection = activeIndex >= 0;
  const currentProject = hasProjectSelection ? projects[activeIndex] : null;
  const showProjectSpotlight = showVideo && hasProjectSelection && currentProject !== null;
