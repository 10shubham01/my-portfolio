...
/**
 * Opaque fixed band above the orange line so scrollable page copy cannot bleed
 * through the spotlight tile (thumbnail, code preview, heading).
 */
export function PageViewportMask() {
  return (
    <>
      <div
